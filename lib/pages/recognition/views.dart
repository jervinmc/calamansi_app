            ...
            name_disease!='' ? Container(
              child:Column(
                ...
                children: [
                  ...
                  Container(
                    padding:EdgeInsets.all(10),
                    child: Text("Descriptions: ${descriptions}")),
                  Container(
                    padding:EdgeInsets.all(10),
                    child: Text("Symptoms: ${symptoms}")),
                  Container(
                    padding:EdgeInsets.all(10),
                    child: Text("Causal Agent: ${causal_agent}")),
                   InkWell(
                     child: Container(
                    padding:EdgeInsets.all(10),
                    child: Text("Click to view Treatment:",style:TextStyle(fontSize: 15,fontWeight: FontWeight.bold))),
                    onTap:()=>{
                       setState(() {
                        isClicked = true;
                      })
                   ...
                   isClicked ? Container(
                    ...
                    child: Text("Organic: ${organic}")) :Text(''),
                  isClicked ?   Container(
                padding:EdgeInsets.all(20),
                    child: Text("Chemical: ${chemical}")) : Text(''),
                  Container(
                    padding:EdgeInsets.all(10),
                    child: Text("Geographical Location of Sample: ${geographical_location}"))
                ],
              )
            ) : Column(
              children: [
